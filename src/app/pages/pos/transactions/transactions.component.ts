...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  formTitle: `${'Transactions'} Filters`,
  formDescription: `Static ${'Transactions'.toLowerCase()} page ready for API integration.`,
  ...
  summaryCards: [
    { label: 'Records', value: `${[{ code: 'INV-2041', name: 'Walk-in Customer', status: 'Posted' }].length}`, caption: 'Static records shown on this page' },
    { label: 'Module', value: 'Orders', caption: 'Current functional area' },
    { label: 'Mode', value: 'Static UI', caption: 'Ready for API replacement' }
  ],
  fields: [{ key: 'invoiceNo', label: 'Invoice Number', type: 'text', placeholder: 'Search invoice' }, { key: 'paymentMode', label: 'Payment Mode', type: 'select', placeholder: 'Choose payment', options: PAYMENT_MODE_OPTIONS }],
  primaryActionLabel: `Search ${'Transactions'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Transactions',
  rows: [{ code: 'INV-2041', name: 'Walk-in Customer', status: 'Posted' }],
