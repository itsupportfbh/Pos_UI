...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  subtitle: 'Review stock movement.',
  formTitle: `${'Inventory Report'} Filters`,
  formDescription: `Static ${'Inventory Report'.toLowerCase()} page ready for API integration.`,
  ...
  summaryCards: [
    { label: 'Records', value: `${[{ code: 'REP-01', name: 'Inventory Snapshot', status: 'Posted' }].length}`, caption: 'Static records shown on this page' },
    { label: 'Module', value: 'Reports', caption: 'Current functional area' },
    { label: 'Mode', value: 'Static UI', caption: 'Ready for API replacement' }
  ],
  fields: [{ key: 'branch', label: 'Branch', type: 'select', placeholder: 'Choose branch', options: BRANCH_OPTIONS }, { key: 'category', label: 'Category', type: 'select', placeholder: 'Choose category', options: CATEGORY_OPTIONS }],
  primaryActionLabel: `Search ${'Inventory Report'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Inventory Report',
  rows: [{ code: 'REP-01', name: 'Inventory Snapshot', status: 'Posted' }],
