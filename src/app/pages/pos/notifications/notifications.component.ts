...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  title: 'Alert Center',
  subtitle: 'Monitor low stock and system alerts.',
  formTitle: `${'Alert Center'} Filters`,
  formDescription: `Static ${'Alert Center'.toLowerCase()} page ready for API integration.`,
  tableTitle: 'Alert Center',
  ...
  summaryCards: [
    { label: 'Records', value: `${[{ code: 'ALT-01', name: 'Low Stock Alert', status: 'Pending' }].length}`, caption: 'Static records shown on this page' },
    { label: 'Module', value: 'Notifications', caption: 'Current functional area' },
  ...
  primaryActionLabel: `Search ${'Alert Center'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Alert Center',
  rows: [{ code: 'ALT-01', name: 'Low Stock Alert', status: 'Pending' }],
