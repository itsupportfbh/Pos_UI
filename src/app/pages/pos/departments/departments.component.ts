...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  title: 'Departments',
  subtitle: 'Maintain departments used for reporting.',
  formTitle: `${'Departments'} Filters`,
  formDescription: `Static ${'Departments'.toLowerCase()} page ready for API integration.`,
  ...
  fields: [{ key: 'departmentName', label: 'Department Name', type: 'text', placeholder: 'Sales' }],
  primaryActionLabel: `Search ${'Departments'}`,
  secondaryActionLabel: 'Clear Filters',
  showAddNewButton: true,
  addNewLabel: 'Add New',
  tableCaption: 'Departments',
  rows: [{ code: 'DEP-01', name: 'Sales', departmentName: 'Sales', branch: 'Head Office', status: 'Active' }],
  columns: CODE_NAME_COLUMNS
};
const ADD_DIALOG_CONFIG: FeaturePageConfig | null = {
  eyebrow: 'Organization',
  title: 'Create Department',
  subtitle: 'Create a new department for reporting.',
  formTitle: `${'Create Department'} Filters`,
  formDescription: `Static ${'Create Department'.toLowerCase()} page ready for API integration.`,
  tableTitle: 'Create Department',
  tableDescription: 'Replace this static data with your API response later.',
  helperPoints: ['This screen is structured for easy API binding.', 'The layout is intentionally separated into filters, summary, and table.'],
  summaryCards: [
  ...
  fields: [{ key: 'departmentName', label: 'Department Name', type: 'text', placeholder: 'Sales' }, { key: 'branch', label: 'Branch', type: 'select', placeholder: 'Choose branch', options: BRANCH_OPTIONS }],
  primaryActionLabel: `Search ${'Create Department'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Create Department',
  rows: [{ code: 'DEP-10', name: 'Warehouse', departmentName: 'Warehouse', branch: 'City Center', status: 'Draft' }],
  columns: CODE_NAME_COLUMNS
};
