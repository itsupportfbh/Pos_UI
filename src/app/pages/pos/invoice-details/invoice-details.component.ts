...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  subtitle: 'Inspect invoice items and totals.',
  formTitle: `${'Invoice Details'} Filters`,
  formDescription: `Static ${'Invoice Details'.toLowerCase()} page ready for API integration.`,
  ...
  summaryCards: [
    { label: 'Records', value: `${[{ code: 'INV-2041', name: 'Arabica Coffee 250g', status: 'Posted' }].length}`, caption: 'Static records shown on this page' },
    { label: 'Module', value: 'Orders', caption: 'Current functional area' },
    { label: 'Mode', value: 'Static UI', caption: 'Ready for API replacement' }
  ],
  fields: [{ key: 'invoiceNo', label: 'Invoice Number', type: 'text', placeholder: 'INV-2041' }],
  primaryActionLabel: `Search ${'Invoice Details'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Invoice Details',
  rows: [{ code: 'INV-2041', name: 'Arabica Coffee 250g', status: 'Posted' }],
