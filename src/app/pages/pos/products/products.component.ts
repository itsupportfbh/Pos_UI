...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  formTitle: `${'Product List'} Filters`,
  formDescription: `Static ${'Product List'.toLowerCase()} page ready for API integration.`,
  ...
  primaryActionLabel: `Search ${'Product List'}`,
  secondaryActionLabel: 'Clear Filters',
  showAddNewButton: true,
  addNewLabel: 'Add New',
  tableCaption: 'Product List',
