...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  formDescription: `Static ${'Print Bills'.toLowerCase()} page ready for API integration.`,
  tableTitle: 'Print Bills',
  ...
  primaryActionLabel: `Search ${'Print Bills'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Print Bills',
  rows: [{ invoiceNo: 'INV-2041', payment: 'Cash', total: 28.5, status: 'Printed' }],
  columns: [{ field: 'invoiceNo', header: 'Invoice', sortable: true, width: '10rem' }, { field: 'payment', header: 'Payment', sortable: true, width: '8rem' }, { field: 'total', header: 'Total', type: 'currency', sortable: true, width: '8rem' }, STATUS_COLUMN]
};
