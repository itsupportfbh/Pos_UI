...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  subtitle: 'Identify the highest moving products.',
  formTitle: `${'Product-wise Sales'} Filters`,
  formDescription: `Static ${'Product-wise Sales'.toLowerCase()} page ready for API integration.`,
  tableTitle: 'Product-wise Sales',
  ...
  primaryActionLabel: `Search ${'Product-wise Sales'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Product-wise Sales',
