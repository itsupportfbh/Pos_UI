...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  subtitle: 'Add store expenses and track categories.',
  formTitle: `${'Expense Register'} Filters`,
  formDescription: `Static ${'Expense Register'.toLowerCase()} page ready for API integration.`,
  ...
  summaryCards: [
    { label: 'Records', value: `${[{ code: 'EXP-4101', name: 'Utilities', status: 'Posted' }].length}`, caption: 'Static records shown on this page' },
  ...
  primaryActionLabel: `Search ${'Expense Register'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Expense Register',
  rows: [{ code: 'EXP-4101', name: 'Utilities', status: 'Posted' }],
