...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  subtitle: 'Track revenue, cost, and profit trend.',
  formTitle: `${'Monthly Profit'} Filters`,
  formDescription: `Static ${'Monthly Profit'.toLowerCase()} page ready for API integration.`,
  tableTitle: 'Monthly Profit',
  ...
  primaryActionLabel: `Search ${'Monthly Profit'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Monthly Profit',
...
@Component({
  ...
  styleUrl: './monthly-profit.component.css'
})
