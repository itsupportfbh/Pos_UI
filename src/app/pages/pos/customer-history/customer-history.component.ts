...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  subtitle: 'Review customer purchase history.',
  formTitle: `${'Purchase History'} Filters`,
  formDescription: `Static ${'Purchase History'.toLowerCase()} page ready for API integration.`,
  ...
  summaryCards: [
    { label: 'Records', value: `${[{ code: 'INV-2041', name: 'Asha Retail', status: 'Posted' }].length}`, caption: 'Static records shown on this page' },
  ...
  primaryActionLabel: `Search ${'Purchase History'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Purchase History',
  rows: [{ code: 'INV-2041', name: 'Asha Retail', status: 'Posted' }],
