...
export class CustomerHistoryComponent {  readonly formState: Record<string, string | Date | null> = {};
  readonly dialogFormState: Record<string, string | Date | null> = {};
  showAddDialog = false;
  showFilterSidebar = false;
  readonly pageEyebrow = 'Customers';
  readonly pageTitle = 'Purchase History';
  readonly pageSubtitle = 'Review customer purchase history.';
  readonly customerSuggestions: string[] = [];
  readonly branchOptions = BRANCH_OPTIONS;  
  readonly filterTitle = `${'Purchase History'} Filters`;
  readonly filterDescription = `API data will be loaded for ${'Purchase History'.toLowerCase()}.`;
  readonly fields: any[] = CUSTOMER_FIELDS;
  readonly primaryActionLabel = `Search ${'Purchase History'}`;
