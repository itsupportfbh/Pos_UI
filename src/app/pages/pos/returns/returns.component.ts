...
const PAGE_CONFIG: FeaturePageConfig = {
  ...
  formTitle: `${'Returns & Refunds'} Filters`,
  formDescription: `Static ${'Returns & Refunds'.toLowerCase()} page ready for API integration.`,
  tableTitle: 'Returns & Refunds',
  ...
  primaryActionLabel: `Search ${'Returns & Refunds'}`,
  secondaryActionLabel: 'Clear Filters',
  tableCaption: 'Returns & Refunds',
