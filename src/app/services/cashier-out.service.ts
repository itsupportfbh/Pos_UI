...
export class CashierOutService {
  private readonly controllerPath = 'CashierOut';
  ...
  create(payload: CashierOut): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: CashierOut): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<CashierOut>> {
    return this.http.get<ApiListResponse<CashierOut>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
