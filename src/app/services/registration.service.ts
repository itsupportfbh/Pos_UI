...
export class RegistrationService {
  private readonly controllerPath = 'Registration';
  ...
  create(payload: Registration): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: Registration): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<Registration>> {
    return this.http.get<ApiListResponse<Registration>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
