...
export interface CurrencyDecimalFormat {
  Id?: number;
  RowNumber?: number;
  Code?: string;
  Name?: string;
...
export class CurrencyDecimalFormatService {
  private readonly controllerPath = 'CurrencyDecimalFormat';
  ...
  create(payload: CurrencyDecimalFormat): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: CurrencyDecimalFormat): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<CurrencyDecimalFormat>> {
    return this.http.get<ApiListResponse<CurrencyDecimalFormat>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
