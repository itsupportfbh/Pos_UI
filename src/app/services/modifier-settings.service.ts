...
export class ModifierSettingsService {
  private readonly controllerPath = 'ModifierSettings';
  ...
  create(payload: ModifierSettings): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: ModifierSettings): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<ModifierSettings>> {
    return this.http.get<ApiListResponse<ModifierSettings>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
