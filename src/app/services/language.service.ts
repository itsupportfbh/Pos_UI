...
export class LanguageService {
  private readonly controllerPath = 'Language';
  ...
  create(payload: Language): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: Language): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<Language>> {
    return this.http.get<ApiListResponse<Language>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
