...
export class MenuSettingService {
  private readonly controllerPath = 'MenuSetting';
  ...
  create(payload: MenuSetting): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: MenuSetting): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<MenuSetting>> {
    return this.http.get<ApiListResponse<MenuSetting>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
