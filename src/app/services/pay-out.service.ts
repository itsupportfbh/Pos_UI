...
export class PayOutService {
  private readonly controllerPath = 'PayOut';
  ...
  create(payload: PayOut): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: PayOut): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<PayOut>> {
    return this.http.get<ApiListResponse<PayOut>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
