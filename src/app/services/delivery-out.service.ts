...
export class DeliveryOutService {
  private readonly controllerPath = 'DeliveryOut';
  ...
  create(payload: DeliveryOut): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: DeliveryOut): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<DeliveryOut>> {
    return this.http.get<ApiListResponse<DeliveryOut>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
