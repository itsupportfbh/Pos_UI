...
export class MenuPriceChangeService {
  private readonly controllerPath = 'MenuPriceChange';
  ...
  create(payload: MenuPriceChange): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: MenuPriceChange): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<MenuPriceChange>> {
    return this.http.get<ApiListResponse<MenuPriceChange>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
