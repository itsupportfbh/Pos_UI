...
export class TipAdjustmentService {
  private readonly controllerPath = 'TipAdjustment';
  ...
  create(payload: TipAdjustment): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: TipAdjustment): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<TipAdjustment>> {
    return this.http.get<ApiListResponse<TipAdjustment>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
