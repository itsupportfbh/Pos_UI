...
export class TareService {
  private readonly controllerPath = 'Tare';
  ...
  create(payload: Tare): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: Tare): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<Tare>> {
    return this.http.get<ApiListResponse<Tare>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
