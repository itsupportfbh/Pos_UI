...
export class OrderEditService {
  private readonly controllerPath = 'OrderEdit';
  ...
  create(payload: OrderEdit): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: OrderEdit): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<OrderEdit>> {
    return this.http.get<ApiListResponse<OrderEdit>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
