...
export class WeighingScaleService {
  private readonly controllerPath = 'WeighingScale';
  ...
  create(payload: WeighingScale): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: WeighingScale): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<WeighingScale>> {
    return this.http.get<ApiListResponse<WeighingScale>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
