...
export class CallerIdService {
  private readonly controllerPath = 'CallerId';
  ...
  create(payload: CallerId): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: CallerId): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<CallerId>> {
    return this.http.get<ApiListResponse<CallerId>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
