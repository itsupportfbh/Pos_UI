...
export class EmployeeRegistrationService {
  private readonly controllerPath = 'EmployeeRegistration';
  ...
  create(payload: EmployeeRegistration): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: EmployeeRegistration): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<EmployeeRegistration>> {
    return this.http.get<ApiListResponse<EmployeeRegistration>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
