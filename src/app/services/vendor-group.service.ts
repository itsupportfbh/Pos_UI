...
export class VendorGroupService {
  private readonly controllerPath = 'VendorGroup';
  ...
  create(payload: VendorGroup): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: VendorGroup): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<VendorGroup>> {
    return this.http.get<ApiListResponse<VendorGroup>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
