...
export class AnnouncementService {
  private readonly controllerPath = 'Announcement';
  ...
  create(payload: Announcement): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: Announcement): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<Announcement>> {
    return this.http.get<ApiListResponse<Announcement>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
