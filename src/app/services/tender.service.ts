...
export class TenderService {
  private readonly controllerPath = 'Tender';
  ...
  create(payload: Tender): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: Tender): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<Tender>> {
    return this.http.get<ApiListResponse<Tender>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
