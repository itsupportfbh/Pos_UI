...
export class VendorManagerService {
  private readonly controllerPath = 'VendorManager';
  ...
  create(payload: VendorManager): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: VendorManager): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<VendorManager>> {
    return this.http.get<ApiListResponse<VendorManager>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
