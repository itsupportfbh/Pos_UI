...
export class PurchaseOrderService {
  private readonly controllerPath = 'PurchaseOrder';
  ...
  update(payload: PurchaseOrder): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<PurchaseOrder>> {
    return this.http.get<ApiListResponse<PurchaseOrder>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
