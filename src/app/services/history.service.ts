...
export class HistoryService {
  private readonly controllerPath = 'History';
  ...
  create(payload: History): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: History): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<History>> {
    return this.http.get<ApiListResponse<History>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
