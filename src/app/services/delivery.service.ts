...
export class DeliveryService {
  private readonly controllerPath = 'Delivery';
  ...
  create(payload: Delivery): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: Delivery): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<Delivery>> {
    return this.http.get<ApiListResponse<Delivery>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
