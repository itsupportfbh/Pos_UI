...
export interface MembershipManagement {
  Id?: number;
  RowNumber?: number;
  Code?: string;
  Name?: string;
...
export class MembershipManagementService {
  private readonly controllerPath = 'MembershipManagement';
  ...
  create(payload: MembershipManagement): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: MembershipManagement): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<MembershipManagement>> {
    return this.http.get<ApiListResponse<MembershipManagement>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
