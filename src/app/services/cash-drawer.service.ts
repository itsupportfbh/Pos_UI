...
export class CashDrawerService {
  private readonly controllerPath = 'CashDrawer';
  ...
  create(payload: CashDrawer): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: CashDrawer): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<CashDrawer>> {
    return this.http.get<ApiListResponse<CashDrawer>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
