...
export interface DataInitialization {
  Id?: number;
  RowNumber?: number;
  Code?: string;
  Name?: string;
...
export class DataInitializationService {
  private readonly controllerPath = 'DataInitialization';
  ...
  create(payload: DataInitialization): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: DataInitialization): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<DataInitialization>> {
    return this.http.get<ApiListResponse<DataInitialization>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
