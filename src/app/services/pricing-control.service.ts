...
export class PricingControlService {
  private readonly controllerPath = 'PricingControl';
  ...
  create(payload: PricingControl): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: PricingControl): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<PricingControl>> {
    return this.http.get<ApiListResponse<PricingControl>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
