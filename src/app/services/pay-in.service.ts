...
export class PayInService {
  private readonly controllerPath = 'PayIn';
  ...
  create(payload: PayIn): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: PayIn): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<PayIn>> {
    return this.http.get<ApiListResponse<PayIn>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
