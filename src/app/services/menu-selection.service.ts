...
export class MenuSelectionService {
  private readonly controllerPath = 'MenuSelection';
  ...
  create(payload: MenuSelection): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: MenuSelection): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<MenuSelection>> {
    return this.http.get<ApiListResponse<MenuSelection>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
