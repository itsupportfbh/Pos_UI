...
export class CashierInService {
  private readonly controllerPath = 'CashierIn';
  ...
  create(payload: CashierIn): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: CashierIn): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<CashierIn>> {
    return this.http.get<ApiListResponse<CashierIn>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
