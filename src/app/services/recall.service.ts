...
export class RecallService {
  private readonly controllerPath = 'Recall';
  ...
  create(payload: Recall): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/${this.controllerPath}/Create`, payload);
  }

  update(payload: Recall): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/${this.controllerPath}/Update`, payload);
  }

  getAll(): Observable<ApiListResponse<Recall>> {
    return this.http.get<ApiListResponse<Recall>>(`${this.baseUrl}/${this.controllerPath}/GetAll`);
  }
